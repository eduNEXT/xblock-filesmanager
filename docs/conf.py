...
"""
xblock-filesmanager documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'xblock-filesmanager',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/eduNEXT/xblock-filesmanager",
...
#
# html_title = 'xblock-filesmanager v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'FilesManager Xblock for Open edX',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'filesmanager'),
                os.path.join(root_path, 'filesmanager/migrations')])
